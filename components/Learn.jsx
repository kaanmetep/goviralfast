...
const Learn = () => {
  ...
  return (
    <div className="mt-20 px-4 relative max-w-6xl mx-auto" id="learn">
      <div className="py-8 text-center">
        <h2 className="relative inline-block text-4xl font-bold mb-4">
          How does it work?
          <span className="absolute h-3 w-full bg-yellow-300 bottom-1 left-0 -z-10 rounded-md  "></span>
        </h2>
      ...
      <div className="relative">
        {/* Connecting line */}
        <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-yellow-100 via-yellow-400 to-yellow-500 transform -translate-x-1/2 rounded-full"></div>
